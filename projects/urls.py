...
urlpatterns = [
    ...
    path('<int:pk>/document_upload/', ProjectDocumentUpload.as_view(), name='project-document-upload'),
    ...
    path('tasks/<int:pk>/document_upload/', TaskDocumentUpload.as_view(), name='task-document-upload'),
