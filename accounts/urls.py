...
from .views import (
    ...
    AccountsPasswordResetConfirm,
    AccountsPasswordResetDoneView,
    AccountsPasswordResetView,
    AccountsProfile,
    AccountsRegisterActivate,
    AccountsRegisterDoneView,
...
urlpatterns = [
    ...
    path(
        "activate/<str:user_hash>/<str:token>/",
        AccountsRegisterActivate.as_view(),
        name="activate",
    ),
    ...
    path(
        "password_reset_done/",
        AccountsPasswordResetDoneView.as_view(),
        name="password-reset-done",
    ),
    path(
        "password_reset_confirm/<str:uidb64>/<str:token>/",
        AccountsPasswordResetConfirm.as_view(),
        name="password-reset-confirm",
    ),
    path(
        "password_reset_complete/",
        AccountsPasswordResetComplete.as_view(),
        name="password-reset-complete",
    ),
    path("profile/", AccountsProfile.as_view(), name="profile"),
]
